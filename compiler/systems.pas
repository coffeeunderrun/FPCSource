...
{$j-}
    const
       ...
       systems_embedded = [system_i386_embedded,system_m68k_embedded,
                           ...
                           system_aarch64_embedded, system_m65xx_embedded];
...
{$endif not DISABLE_TLS_DIRECTORY}
       ...
       systems_allow_external_far_var = [system_i8086_msdos,system_i8086_win16,system_i8086_embedded,system_m65xx_embedded];
...
{$ifdef m65xx}
  default_target(system_m65xx_embedded);
{$endif m65xx}
